...
// void proc_gather_pschedinfo(struct pschedinfo *result)
// {
//   // gather the states of all processes to the pschedinfo
//   struct proc *p;
...
void wakeup2(void)
{
  // Iterate through the process table to check sleeping processes
  // struct proc *p;
  // for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
  // {
